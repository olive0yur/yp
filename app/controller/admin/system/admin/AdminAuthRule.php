...
class AdminAuthRule extends Base
{
    ...
    public function __construct(App $app, AdminAuthRuleRepository $repository)
    {
    ...
    public function list()
    {
        ...
        return $this->fetch('system/admin/auth/list', [
            'editAuth' => admin_auth('adminEditAuthMenu')
        ]);
    }
    ...
    public function edit()
    {
        ...
        if ($this->request->isPost()) {
            ...
            try {
                ...
                admin_log(3, '修改目录信息 id:' . $info['id'], ['old' => $old, 'new' => $param]);
                if ($res) {
            ...
            return $this->fetch('system/admin/auth/edit', [
                'info' => $info
            ]);
        }
    }
