...
class Album extends Base
{
    ...
    public function __construct(App $app, UnionAlbumRepository $repository)
    {
    ...
    public function list()
    {
        ...
        return $this->fetch('/box/album/list', [
            'addAuth' => company_auth('ompanyBoxAlbumAdd'),
            'editAuth' => company_auth('ompanyBoxAlbumEdit'),
            'delAuth' => company_auth('ompanyBoxAlbumDel'),
        ]);
    }
    ...
    public function add()
    {
        if ($this->request->isPost()) {
            ...
            return $this->fetch('box/album/add');
        }
    }
    ...
    public function edit()
    {
        ...
        if ($this->request->isPost()) {
            ...
            return $this->fetch('box/album/edit', [
                'info' => $info,
    ...
    public function del()
    {
        ...
        try {
            ...
            if ($data) {
                admin_log(4, '删除肓盒专辑 ids:' . implode(',', $ids), $data);
