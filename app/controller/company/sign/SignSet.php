...
class SignSet extends Base
{
    ...
    public function list()
    {
        ...
        return $this->fetch('sign/set/list');
    }
    ...
    public function add()
    {
        if ($this->request->isPost()) {
            ...
            try {
                ...
                if ($res) {
                    company_user_log(3, '添加签到配置成功', $param);
            ...
            return $this->fetch('sign/set/add', [
    ...
    public function edit()
    {
        ...
        if ($this->request->isPost()) {
            ...
            return $this->fetch('sign/set/edit', [
                'info' => $info
            ]);
        }
    }
