...
class GearLevel extends Base
{
    protected $repository;

    public function __construct(App $app, ToysGearLevelRepository $repository)
    {
        parent::__construct($app);
        $this->repository = $repository;
        $this->assign([
            'addAuth' => company_auth('companyGameGearLevelAdd'),
            'editAuth' => company_auth('companyGameGearLevelEdit'),
            'delAuth' => company_auth('companyGameGearLevelDel'),
        ]);
    }
    ...
    public function list()
    {
        ...
        return $this->fetch('rabbit/gear_level/list');
    }
    ...
    public function add()
    {
        if ($this->request->isPost()) {
            ...
            try {
                ...
                if ($res) {
                    company_user_log(3, '装备等级添加', $param);
            ...
            $this->commonParams();
            return $this->fetch('rabbit/gear_level/add', ['companyId' => $this->request->companyId]);
        }
    }
    ...
    public function edit()
    {
        ...
        if ($this->request->isPost()) {
            ...
            try {
                ...
                if ($res !== false) {
                    company_user_log(3, '装备等级修改', $param);
            ...
            $this->commonParams();
            return $this->fetch('rabbit/gear_level/edit', [
                'info' => $info,
    ...
    public function del()
    {
        ...
        try {
            ...
            if ($data) {
                company_user_log(4, '装备等级删除 ids:' . implode(',', $ids), $data);
