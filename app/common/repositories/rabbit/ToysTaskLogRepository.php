...
use app\common\dao\rabbit\ToysTaskLogDao;
...
/**
 * Class ToysTaskLogRepository
 * @package app\common\repositories\rabbit
 * @mixin ToysTaskLogDao
 */
class ToysTaskLogRepository extends BaseRepository
{

    public function __construct(ToysTaskLogDao $dao)
    {
        $this->dao = $dao;
