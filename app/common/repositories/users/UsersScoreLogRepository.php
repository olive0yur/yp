...
use app\common\dao\users\UsersScoreLogDao;
use app\common\repositories\BaseRepository;
use app\common\repositories\users\user\AgentUserRepository;

class UsersScoreLogRepository extends BaseRepository
{
    const LOG_TYPE = [
        1 => '后台调整',
        2 => '充值',
    ...
    public function __construct(UsersScoreLogDao $dao)
    {
        $this->dao = $dao;
    }
     ...
     * 获取余额日志
     */
    public function scoreLogList($type, $page, $limit, $userId = null, $companyId = null)
    {
